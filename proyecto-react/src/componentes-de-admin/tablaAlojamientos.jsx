...
function TablaAlojamientos() {
    ...
    const iniciarEdicion = (alojamiento) => {
        setEditando(alojamiento.idAlojamiento);
                        ...
                        {filterAlojamientos.map((item, index) => (
                            <tr key={index}>
                                ...
                                {editando === item.idAlojamiento ? (
                                    <>
                                        <td><input type="text" name="Titulo" value={nuevoAlojamiento.Titulo} onChange={manejarCambio} /></td>
                                        <td><input type="text" name="Descripcion" value={nuevoAlojamiento.Descripcion} onChange={manejarCambio} /></td>
                                        <td>
                                        ...
                                        <td><input type="text" name="Latitud" value={nuevoAlojamiento.Latitud} onChange={manejarCambio} /></td>
                                        <td><input type="text" name="Longitud" value={nuevoAlojamiento.Longitud} onChange={manejarCambio} /></td>
                                        <td><input type="number" name="PrecioPorDia" value={nuevoAlojamiento.PrecioPorDia} onChange={manejarCambio} /></td>
                                        <td><input type="number" name="CantidadDormitorios" value={nuevoAlojamiento.CantidadDormitorios} onChange={manejarCambio} /></td>
                                        <td><input type="number" name="CantidadBanios" value={nuevoAlojamiento.CantidadBanios} onChange={manejarCambio} /></td>
                                        <td><input type="text" name="Estado" value={nuevoAlojamiento.Estado} onChange={manejarCambio} /></td>
                                        <td><button onClick={() => enviarEdicion(item.idAlojamiento)}>Guardar</button></td>
                                    </>
                                ) : (
                                    <>
                                        <td>{item.Titulo}</td>
                                        <td>{item.Descripcion}</td>
                                        <td>{item.tipoAlojamientoDescripcion}</td>
                                        <td>{item.Latitud}</td>
                                        <td>{item.Longitud}</td>
                                        <td>{item.PrecioPorDia}</td>
                                        <td>{item.CantidadDormitorios}</td>
                                        <td>{item.CantidadBanios}</td>
                                        <td>{item.Estado}</td>
                                        <td><button onClick={() => iniciarEdicion(item)}>Editar</button></td>
                                    </>
                                )}
                                <td><button onClick={() => borrarAlojamiento(item.idAlojamiento)}>Borrar</button></td>
                            </tr>
                        ))}
                    </tbody>
